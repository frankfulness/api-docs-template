...
![shadch-landing-page](https://github.com/leoMirandaa/shadcn-landing-page/assets/61714687/3ba7b51f-9589-4541-800a-5ab7cecad1b5) <!-- markdownlint-disable-line line-length -->

Build your React landing page effortlessly with the required sections to your project.

<!-- <a href="https://api-docs-template.vercel.app/" target="_blank">Live Demo</a> -->
...
```bash
git clone https://github.com/frankfulness/api-docs-template.git
```
